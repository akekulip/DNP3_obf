...
relay. The experimental results show that the device's signature leaves the interval: it settles on the
configured value, and its interquartile range falls by more than two orders of magnitude. Consequently,
