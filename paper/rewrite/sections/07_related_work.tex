...
add cover traffic. In contrast, our framework targets a plaintext protocol whose feature is one
interval inside a request-response exchange. Because the outstation cannot be changed, it adds no
