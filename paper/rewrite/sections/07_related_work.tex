...
cloud~\cite{mehtaPacerComprehensiveNetwork2022, sabziNetShaperDifferentiallyPrivate2024}. These defenses assume an encrypted payload and a cooperating end host or hypervisor that can
add cover traffic. Unlike those settings, ours carries a plaintext protocol whose leaking feature is one interval
inside a request-response exchange. Because the outstation cannot be changed, it adds no
