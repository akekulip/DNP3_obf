...
and the packet is forwarded unprotected, preserving delivery and forgoing the treatment rather
than corrupting the deadline already in progress. Per-flow protection would need per-flow state
and a way to index it, which this program does not have and we did not evaluate.
