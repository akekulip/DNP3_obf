...
\begin{itemize}
  ...
  \item \textbf{Realize the framework on an Intel Tofino-1} using paired blocker and hold queues
    that sustain a hold until a deadline expires, with an acknowledgment-anchored read lane, a
    request-anchored control lane, and forwarding that stays open when a response arrives after
