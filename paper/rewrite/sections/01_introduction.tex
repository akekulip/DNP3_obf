...
\begin{itemize}
  ...
  \item \textbf{Evaluates the realization against a physical SEL-751A relay}, reporting how closely the released interval reaches its target, what the policy can
