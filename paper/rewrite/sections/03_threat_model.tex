...
adversary the reconnaissance setting describes. The \emph{adaptive} adversary collects obfuscated
traffic and retrains on it, which assumes more access, and answers what remains learnable once the
defense is known: it recovers 0.651 balanced accuracy where the fixed one is left at chance. Both
conditions are ours, chosen to bracket the problem, and the second is the one that limits our
claim.
