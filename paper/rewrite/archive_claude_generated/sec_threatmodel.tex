...
We state the security goals (G1--G4, G6) as testable properties of the master-facing observation;
G5 is an evaluation-validity property that lets the native and defended comparison isolate the defense.
\begin{itemize}
