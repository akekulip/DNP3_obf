...
switch-internal loopbacks (\code{dp8} for RRC, \code{dp10} for BOR) are not observed.}
\label{fig:system}
\end{figure}
...
Defense~4 does not aim for the following, and the evidence does not establish them.
\begin{itemize}
