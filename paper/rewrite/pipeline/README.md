...
| ~~`make_final_figures.py`~~ | **retired 2026-09-07**. It read `../figures/timing/`, which was removed as duplicating `defense4/timing/figures/publication/`, so it can no longer run |
