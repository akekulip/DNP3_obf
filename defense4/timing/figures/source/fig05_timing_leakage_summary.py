...
def main():
    ...
    fs.save(fig, figures_dir(root), "fig05_timing_leakage_summary",
            ...
            caption=(
                ...
                "CLRT to separate the two classes, applied unchanged to Obfuscated traffic, "
            ...
            stats_note=(
                ...
                "refitting to the Obfuscated data; intervals are percentile bootstrap 95 "
                ...
                "an edge at exactly 4.000 ms and 18 percent of Obfuscated observations fall "
