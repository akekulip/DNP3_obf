...
# repair callouts in this zone
callout(40, 82, "parser init (§7.10)", ds.PASS)
callout(72, 70.5, "seq-0 fix (§7.9)", ds.PASS)
...
ax.text(lx + 30, 5, "green = repair", fontsize=6.6, va="center", color=ds.PASS, weight="bold")
