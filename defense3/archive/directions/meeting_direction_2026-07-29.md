> **ARCHIVED (2026-07-30).** This was a mid-run CHECK1/CHECK2/Gate-2 directive, not the
> current project direction. Case A Defense 3 (R1+R2+R3) is complete and validated; see
> `defense3/REPORT.pdf` and `RESUME_STATE.md`. Kept for provenance.
