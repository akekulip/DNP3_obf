...
## Status — audit and rerun package complete; six commits unpushed; manuscript unedited

Working on `paper/campaign-v1-ndss-corrections-20260828`, six commits ahead of `origin/`, from
