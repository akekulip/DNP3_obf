...
def parse_args():
    ap = argparse.ArgumentParser(description="Case-B (dcrn_defense2) bring-up controller.")
...
def bring_up(args, gc):
    ...
    print("=== defense2_setup ===  program=%s  mode=%s  G_i=%.1fms" % (PROG, args.mode, args.gi_ms))
