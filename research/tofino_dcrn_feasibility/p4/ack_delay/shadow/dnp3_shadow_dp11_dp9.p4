/*******************************************************************************
 * dnp3_shadow_dp11_dp9.p4  —  dp11/dp9 DEPLOYMENT VARIANT of the FROZEN dnp3_shadow.p4.
 * NOT a replacement for the frozen file. ONLY difference: PORT_VISION 9w8 -> 9w11 (master moved from
 * the faulty lane 15/0/dp8 to lane 15/3/dp11; PORT_ROLE_AUDIT_20260724.md). Role contract unchanged:
 * master ingress = dir 0 (now dp11), outstation ingress = dir 1 (dp9). All classification/forwarding
 * logic is identical to the frozen file and derives from the two role constants.
 *
 ...
 *
 * WHAT IT DOES:
 *   A transparent bump-in-the-wire between Vision (dp11, master) and Hulk (dp9, outstation).
...
const PortId_t PORT_VISION = 9w11;   // master / dir 0 — REMAPPED dp8->dp11 (lane 15/0 faulty; see
                                     // PORT_ROLE_AUDIT_20260724.md). Role-based contract: master ingress = dir 0.
const PortId_t PORT_HULK   = 9w9;    // outstation / dir 1 (unchanged)
