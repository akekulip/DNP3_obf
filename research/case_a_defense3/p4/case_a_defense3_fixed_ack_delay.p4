...
const bit<8> CD_ACK_RELEASE      = 8w6; /* D3: the ACK left Q_HOLD (the headline event) */
    ...
    apply {
        if (meta.port_ok == 8w0) {
            ...
            if (meta.dequeued == 8w0) {
                ...
                if (meta.role == ROLE_ARM && meta.sess == SESS_MASTER) {
            ...
            } else if (meta.is_pktgen == 8w1 || meta.pkt_class == CLASS_RESP
            ...
            if (meta.pkt_class == CLASS_RESP || meta.pkt_class == CLASS_ACK_REL) {
            ...
            if (meta.dequeued == 8w0) {
                ...
                if (meta.role == ROLE_BLOCK) {
                    ...
                    if (meta.verdict == V_RESP && meta.txn_active == 8w1) {
                        to_hold();
                        if (meta.tag_diff == 8w0) {   /* rel_diff == 0: ACK already out */
                            ctr_fresh.count(CF_RESP_HOLD_LATE);
                        } else {
