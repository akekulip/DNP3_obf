...
parser EgParser(packet_in pkt, out eg_headers_t hdr, out eg_meta_t meta,
    ...
    state pl_0 { transition accept; }
    state pl_1 { pkt.extract(hdr.pay1); transition accept; }
    state pl_2 { pkt.extract(hdr.pay2); transition accept; }
    state pl_3 { pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_4 { pkt.extract(hdr.pay4); transition accept; }
    state pl_5 { pkt.extract(hdr.pay4); pkt.extract(hdr.pay1); transition accept; }
    state pl_6 { pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); transition accept; }
    state pl_7 { pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_8 { pkt.extract(hdr.pay8); transition accept; }
    state pl_9 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay1); transition accept; }
    state pl_10 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay2); transition accept; }
    state pl_11 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_12 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); transition accept; }
    state pl_13 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); pkt.extract(hdr.pay1); transition accept; }
    state pl_14 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); transition accept; }
    state pl_15 { pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_16 { pkt.extract(hdr.pay16); transition accept; }
    state pl_17 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay1); transition accept; }
    state pl_18 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay2); transition accept; }
    state pl_19 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_20 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay4); transition accept; }
    state pl_21 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay4); pkt.extract(hdr.pay1); transition accept; }
    state pl_22 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); transition accept; }
    state pl_23 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_24 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); transition accept; }
    state pl_25 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay1); transition accept; }
    state pl_26 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay2); transition accept; }
    state pl_27 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_28 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); transition accept; }
    state pl_29 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); pkt.extract(hdr.pay1); transition accept; }
    state pl_30 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); transition accept; }
    state pl_31 { pkt.extract(hdr.pay16); pkt.extract(hdr.pay8); pkt.extract(hdr.pay4); pkt.extract(hdr.pay2); pkt.extract(hdr.pay1); transition accept; }
    state pl_32 { pkt.extract(hdr.pay32); transition accept; }
    state pl_33 { pkt.extract(hdr.pay32); pkt.extract(hdr.pay1); transition accept; }
...
control Egress(inout eg_headers_t hdr, inout eg_meta_t meta,
    ...
    action pad_d74() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d73() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d72() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; }
    action pad_d71() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d70() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d69() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d68() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; }
    action pad_d67() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d66() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d65() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d64() { meta.normalized = 8w1; hdr.pad64.setValid(); hdr.pad64.f = 0; }
    action pad_d63() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    ...
    action pad_d61() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d60() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; }
    action pad_d59() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d58() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d57() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d56() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; }
    action pad_d55() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    ...
    action pad_d53() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    ...
    action pad_d51() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d50() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d49() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d48() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad16.setValid(); hdr.pad16.f = 0; }
    action pad_d47() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d46() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d45() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d44() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad4.setValid(); hdr.pad4.f = 0; }
    action pad_d43() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    action pad_d42() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad2.setValid(); hdr.pad2.f = 0; }
    action pad_d41() { meta.normalized = 8w1; hdr.pad32.setValid(); hdr.pad32.f = 0; hdr.pad8.setValid(); hdr.pad8.f = 0; hdr.pad1.setValid(); hdr.pad1.f = 0; }
    ...
    table size_norm {
        ...
        actions = { pad_none; pad_d74; pad_d73; pad_d72; pad_d71; pad_d70; pad_d69; pad_d68; pad_d67; pad_d66; pad_d65; pad_d64; pad_d63; pad_d62; pad_d61; pad_d60; pad_d59; pad_d58; pad_d57; pad_d56; pad_d55; pad_d54; pad_d53; pad_d52; pad_d51; pad_d50; pad_d49; pad_d48; pad_d47; pad_d46; pad_d45; pad_d44; pad_d43; pad_d42; pad_d41; pad_d40; pad_d39; pad_d38; pad_d37; pad_d36; pad_d35; pad_d34; pad_d33; pad_d32; pad_d31; pad_d30; pad_d29; pad_d28; pad_d27; pad_d26; pad_d25; pad_d24; pad_d23; pad_d22; pad_d21; pad_d20; pad_d19; pad_d18; pad_d17; pad_d16; pad_d15; pad_d14; pad_d13; pad_d12; pad_d11; pad_d10; pad_d9; pad_d8; pad_d7; pad_d6; pad_d5; pad_d4; pad_d3; pad_d2; pad_d1; pad_d0; }
        const entries = {
            (16w40  , 16w54  ) : pad_d74();
            (16w41  , 16w55  ) : pad_d73();
            (16w42  , 16w56  ) : pad_d72();
