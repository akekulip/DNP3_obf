...
parser IgParser(packet_in pkt, out headers_t hdr, out ig_meta_t meta,
    ...
    state start {
        ...
        meta.now_word = 32w0; meta.dl_val = 32w0; meta.age = 32w0;
        meta.exp_tag = 8w0;   meta.tag_val = 8w0;       meta.tag_diff = 8w0;
        meta.expired = 8w0;
...
control Ingress(inout headers_t hdr, inout ig_meta_t meta,
    ...
    action set_arm()  { meta.dl_val = 32w2; }
    action set_none() { meta.dl_val = 32w0; }
