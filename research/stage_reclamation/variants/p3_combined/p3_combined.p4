/* ============================================================================
 * p3_combined.p4 — variant P3: P1 (packed state) + P2 (egress telemetry offload)
 *
 * Both changes at once. P2 is known not to save an ingress stage, so this measures
 * whether the offload costs P1 anything and what ingress headroom it frees.
 *
